 ...
 * @author gelo
 */
public class PERSONALACC extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(PERSONALACC.class.getName());

    /**
     * Creates new form PERSONALACC
     */
    public PERSONALACC() {
        initComponents();
...
this.dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new PERSONALACC().setVisible(true));
    }
 ...
 private void loadUserAccountInfo() {
        try {
            ...
            // Query user data
            String query = "SELECT username, email, birthdate, created_at " +
                          "FROM users " +
                          "WHERE user_id = ?";
            ...
            if (rs.next()) {
                ...
                jLabel6.setText(rs.getString("username"));
                jLabel8.setText(rs.getString("email"));
                
                // Format birthdate
                java.sql.Date birthdate = rs.getDate("birthdate");
                if (birthdate != null) {
                    jLabel7.setText(birthdate.toString());
                } else {
                    jLabel7.setText("Not set");
                }
                ...
                if (createdAt != null) {
                    ...
                    jLabel9.setText(sdf.format(createdAt));
                } else {
            ...
            javax.swing.JOptionPane.showMessageDialog(this,
                "Error loading account information: " + e.getMessage(),
                "Database Error",
